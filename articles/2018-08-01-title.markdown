---
layout: post
title: "Building Applications with Golang and Angular"
description: "In this article, you will learn how to build modern applications with Golang and Angular. Throughout the article, you will build a secure Golang API that will support a ToDo list application that you will develop with Angular. To facilitate the identity management, you will integrate Auth0 both in your backend and in your frontend."
date: "2018-08-01 08:30"
author:
  name: "Lasse Martin Jakobsen"
  url: "ifndef_lmj"
  mail: "lja@pungy.dk"
  avatar: "https://twitter.com/ifndef_lmj/profile_image?size=original"
related:
